package colin.com.blendsugar.ui.view.pupop;
 ...
 * @date 2018/7/12
 */
public class PupopActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public static void lanuch(Activity activity) {
        Intent intent = new Intent(activity, PupopActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pupop);
    ...
    private void handleLogic(View contentView) {
        View.OnClickListener listener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(PupopActivity.this, showContent, Toast.LENGTH_SHORT).show();
            }
        };
